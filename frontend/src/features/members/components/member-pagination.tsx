            ...
            <span key={p} className="flex items-center gap-1">
              ...
              <button
                ...
                className={cn(
                  ...
                  p === page
                    ? "border-primary/40 bg-primary/15 text-primary shadow-neon"
                    : "border-border/50 bg-card/60 text-muted-foreground hover:border-primary/40 hover:bg-primary/10 hover:text-primary",
                )}
              >
                {p}
              </button>
